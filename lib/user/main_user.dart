import 'package:flash_dash_delivery/user/create_delivery.dart';
      ...
      child: Scaffold(
          ...
          child: Padding(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment
                  .stretch, // สำคัญ! เพื่อให้ textAlign.center ทำงานได้
              children: [
                Text(
                  'Flash-Dash Delivery',
                ...
                Image.asset('assets/image/mainuser.png', height: 250),
              ],
            ),
          ),
        ),
        ...
        bottomNavigationBar: loginData != null
            ? CustomBottomNavBar(
                ...
                loginData:
                    loginData!, // <-- ส่งข้อมูลที่หน้านี้ได้รับมา ให้ Navbar
              )
